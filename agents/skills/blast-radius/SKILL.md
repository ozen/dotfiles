...
6. For a big or wide change, run it as an `arena`. Ask several independent subagents the same question and merge the answers. Fresh contexts catch different real bugs even though every spawn inherits the main agent's model.
