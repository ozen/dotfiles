...
Start by finding the relevant code. Use the environment's file-listing capability to find directories and files, text search to find key symbols, and file reads to understand the actual implementation. Don't guess from names. Read the code.
