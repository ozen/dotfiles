...
#
# Usage: AGENT_TRANSCRIPTS_DIR=<path> worktree-audit.sh [repo-path]
# The repo path defaults to the current repository. Transcript correlation is
# skipped when AGENT_TRANSCRIPTS_DIR is unset.
set -u
